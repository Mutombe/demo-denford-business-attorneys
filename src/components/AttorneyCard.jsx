  ...
  return (
    ...
    >
      ...
      <div className="mt-5">
        ...
        <div className="mt-4 inline-flex items-center gap-2 font-display text-[0.7rem] tracking-[0.22em] uppercase font-semibold text-navy-700 group-hover:text-gold-500 transition-colors">
          <span>Profile</span>
